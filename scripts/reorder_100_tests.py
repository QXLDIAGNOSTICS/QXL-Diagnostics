...
# Exact 100 tests from user prompt in exact order 1 to 100
user_table = [
...
for num, name, short, slug, dept in user_table:
    fasting = "8 to 10 hours overnight fasting recommended." if "Glucose" in name or "Lipid" in name or "Insulin" in name or "HOMA" in name else "No fasting required."
    ...
    cms_map[slug] = {
        ...
        "parametersCount": "Complete Clinical Investigation",
        "sampleType": sample,
        ...
        "overview": [
            ...
            f"Conducted inside our NABL Certified central super speciality laboratory using automated analyzers, this test follows strict ISO 15189:2022 quality standards.",
...
# Write out exact 100 tests in order
...
print("Successfully generated exact 100 tests in exact LIS order 1 to 100 in src/lib/seoPages/cms100MasterData.ts!")
