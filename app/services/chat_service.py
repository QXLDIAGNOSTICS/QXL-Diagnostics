...
SYSTEM_PROMPT = (
    ...
    "call create_payment_order so the inline Razorpay 'Pay Now' card appears directly in the "
    ...
    "show a payment option is the Razorpay checkout card the system renders automatically "
    ...
    "appeared below for that total amount and ask them to tap it to pay by card, UPI, "
    "netbanking, or wallet. Do not claim "
