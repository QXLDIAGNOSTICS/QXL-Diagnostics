...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/doctors/dr-pritilata-rout", destination: "/dr-pritilata-rout", permanent: true },
      { source: "/doctors/dr-ajitha-pillai", destination: "/dr-ajitha-pillai", permanent: true },
      { source: "/doctors/dr-naveen-kumar-n", destination: "/dr-naveen-kumar-n", permanent: true },
      ...
      { source: "/tests/fasting-blood-sugar", destination: "/fasting-blood-sugar", permanent: true },
      { source: "/tests/post-prandial-blood-sugar", destination: "/post-prandial-blood-sugar", permanent: true },
      { source: "/tests/random-blood-sugar", destination: "/random-blood-sugar", permanent: true },
      { source: "/tests/thyroid-profile", destination: "/thyroid-profile", permanent: true },
      { source: "/tests/tsh", destination: "/tsh", permanent: true },
      { source: "/tests/free-t3", destination: "/free-t3", permanent: true },
      { source: "/tests/free-t4", destination: "/free-t4", permanent: true },
      { source: "/tests/lipid-profile", destination: "/lipid-profile", permanent: true },
      { source: "/tests/liver-function-test", destination: "/liver-function-test", permanent: true },
      { source: "/tests/kidney-function-test", destination: "/kidney-function-test", permanent: true },
      { source: "/tests/creatinine", destination: "/creatinine", permanent: true },
      { source: "/tests/uric-acid", destination: "/uric-acid", permanent: true },
      { source: "/tests/crp", destination: "/crp", permanent: true },
      { source: "/tests/erythrocyte-sedimentation-rate", destination: "/erythrocyte-sedimentation-rate", permanent: true },
      { source: "/tests/vitamin-d", destination: "/vitamin-d", permanent: true },
      { source: "/tests/vitamin-b12", destination: "/vitamin-b12", permanent: true },
      { source: "/tests/ferritin", destination: "/ferritin", permanent: true },
      { source: "/tests/iron-profile", destination: "/iron-profile", permanent: true },
      { source: "/tests/calcium", destination: "/calcium", permanent: true },
      { source: "/tests/magnesium", destination: "/magnesium", permanent: true },
      { source: "/tests/electrolytes", destination: "/electrolytes", permanent: true },
      ...
      { source: "/tests/vitamin-b12", destination: "/vitamin-b12", permanent: true },
      { source: "/tests/lipid-profile", destination: "/lipid-profile", permanent: true },
      { source: "/tests/lft", destination: "/liver-function-test", permanent: true },
      { source: "/tests/kft", destination: "/kidney-function-test", permanent: true },
