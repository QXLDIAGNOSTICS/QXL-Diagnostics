...
export const getPhoneDisplay = (): string => {
  ...
  return settings?.phone_display || "+91 9964 639 639";
};
...
export const PHONE_DISPLAY = "+91 9964 639 639";
...
export const NABL_CERTIFICATE = CONFIG_NABL_CERT; // NABL Certificate MC-6849
...
export const LOCATIONS: BusinessLocation[] = [
  {
    ...
    lng: 77.4850301,
    isNabl: true,
    hours: "Open 24 Hours, 7 Days a Week (24×7)",
