...
export const RAKSHA_CAMPAIGN_CONFIG: RakshaCampaignConfig = {
  ...
  heroSubheadline: "Prioritise wellness with a comprehensive full body health check from QXL Diagnostics.",
  offerHeading: "Exclusive Full Body Preventive Health Offer",
  offerTitle: "Full Body Health Checkup",
  specialPrice: 1770,
  originalPrice: 4696,
  currencySymbol: "₹",
  discountBadgeText: "62% OFF (SAVE ₹2,926)",
  parameterCount: 80,
  offerValidityText: "SPECIAL PREVENTIVE HEALTH OFFER • VALID TODAY",
  disclaimerText: "Offer price includes key health parameters and free doorstep blood collection across Bengaluru. Subject to daily phlebotomy slot availability.",
  ...
  faqItems: [
    {
      question: "What is included in the full body health offer?",
      answer: "The full body health offer is a specially curated preventive health checkup package provided by QXL Diagnostics. It covers essential health parameters across major health areas including CBC, HbA1c, Liver Function, Kidney Function, Thyroid Profile, Lipid Profile, Bone/Mineral Health, and Urine Routine.",
    },
    {
      question: "What tests are included in the package?",
      answer: "The full body health package includes comprehensive diagnostic parameters across major health areas: Complete Blood Count, HbA1c & Fasting Sugar, Heart & Lipid Profile, Liver Function Test, Kidney Function Test, Thyroid Screening, Bone & Mineral Health, and Urinary Routine.",
    },
    {
    ...
    {
      question: "How long is the Special Full Body Offer valid?",
      answer: "The Special Full Body Offer is available for online bookings across Bengaluru. Slots are subject to daily phlebotomy availability, so early booking is recommended.",
    },
  ],
};
