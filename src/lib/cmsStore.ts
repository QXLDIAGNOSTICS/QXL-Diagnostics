...
const defaultPackages = [
  {
    ...
    originalPrice: "5800",
    save_amount: "5000",
    includes: "CBC (26), HbA1c & Fasting Sugar (3), Lipid Profile (8), Liver Function (11), Kidney Function (8), Thyroid Profile (3), Bone, Mineral & Urine Analysis (21).",
    parameters: "80 Parameters",
    tag: "FESTIVE OFFER",
    most_booked: true,
    benefits: ["80 Health Parameters", "8 Major Organ Systems", "Free Bengaluru Home Collection"],
    who_should_take: "Gift your sibling or family comprehensive diagnostic screening.",
    age: "All Ages",
    gender: "Male / Female",
