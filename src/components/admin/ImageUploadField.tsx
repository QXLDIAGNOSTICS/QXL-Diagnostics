        ...
        <div className="flex-1 space-y-1.5">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              disabled={uploading}
              className="text-[11px] text-gray-500 dark:text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-[11px] file:font-bold file:bg-sky-50 file:text-sky-700 hover:file:bg-sky-100 dark:file:bg-sky-950/30 dark:file:text-sky-400 cursor-pointer disabled:opacity-60"
            />
            {uploading && <Loader2 className="w-3.5 h-3.5 animate-spin text-sky-600 flex-shrink-0" />}
          </div>
        </div>
      </div>
      {error && (
