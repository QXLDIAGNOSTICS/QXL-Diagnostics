        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#f8faff] rounded-xl border border-gray-100 p-5">
              ...
              <p className="text-slate-600 text-[13px] leading-relaxed">Centre hours are typically Monday–Saturday 7:00 AM–9:00 PM and Sunday 7:00 AM–2:00 PM. Home collection is generally available daily from early morning through evening across Bengaluru; confirm slots while booking.</p>
            </div>
