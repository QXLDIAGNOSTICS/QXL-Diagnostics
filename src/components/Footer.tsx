    ...
    <footer className="relative overflow-hidden" style={{ zIndex: 1, background: BASE }}>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex flex-col items-center md:flex-row md:items-start gap-3">
                ...
                <div className="flex flex-col items-center md:items-start">
                  <a href={`tel:${settings.phone_e164 || settings.contactPhone || '+919964639639'}`} className="text-white text-[13px] font-extrabold hover:text-white/80 transition-colors">{settings.phone_display || settings.contactPhone || '+91 9964 639 639'}</a>
      ...
      >
        <div className="max-w-[1260px] mx-auto px-4 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <p className="text-white/35 text-[12px] font-semibold text-center">
