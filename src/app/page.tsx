        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-900 p-6 rounded-2xl border border-slate-200 dark:border-gray-800 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            ...
            <button 
              ...
              className="text-sm text-sky-700 font-medium hover:underline px-3 py-1 rounded-md hover:bg-sky-50 transition-colors cursor-pointer"
            >
              View All Data
            </button>
          </div>
                  ...
                  <tr key={item.id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-right">
                      <button 
                        ...
                        className="text-sky-700 hover:text-white hover:bg-sky-600 border border-sky-600 px-3 py-1.5 rounded-lg cursor-pointer font-bold transition-all shadow-sm text-xs"
                      >
                        Details
                      </button>
                    </td>
              ...
              <div key={apt.id} className="p-6 space-y-4">
                ...
                <div className="pt-4 flex gap-3">
                  <button 
                    ...
                    className="flex-1 py-2.5 bg-sky-650 hover:bg-sky-700 text-white font-bold rounded-lg transition-colors cursor-pointer text-xs"
                  >
                    Edit Record
                  </button>
                  <button 
