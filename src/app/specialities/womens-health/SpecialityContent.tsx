      ...
      <section className="glass-panel text-[#0c4a6e] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-block bg-[#2563eb] text-white text-xs font-extrabold px-3.5 py-1.5 rounded-full uppercase tracking-widest mb-4 shadow-sm">Women's Health</span>
            <h1 className="text-3xl md:text-5xl font-extrabold mb-4 text-[#0c4a6e] leading-tight">Women's Health, Fertility, Pregnancy &amp; Hormone Testing in Bengaluru</h1>
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section id="test-profiles">
              <h2 className="text-2xl font-bold text-gray-900 mb-5 flex items-center gap-2">
                <Baby className="w-6 h-6 text-sky-600" /> Women's Health Test Profiles
              </h2>
            ...
            <section className="bg-gradient-to-r from-sky-600 to-sky-800 rounded-2xl p-6 md:p-8 text-white shadow-xl">
              <h3 className="text-xl md:text-2xl font-extrabold mb-2 text-white">Book Your Women's Health Profile</h3>
              <p className="text-sky-100 text-sm md:text-base mb-6 font-medium leading-relaxed">Home collection available across Bengaluru. Female phlebotomist on request.</p>
              <div className="flex flex-wrap gap-3">
