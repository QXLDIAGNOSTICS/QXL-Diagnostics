      ...
      <section className="glass-panel text-[#0c4a6e] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-[#0c4a6e] leading-tight">Women's Health, Fertility, Pregnancy &amp; Hormone Testing in Bengaluru</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-gradient-to-r from-sky-600 to-sky-900 rounded-2xl p-6 text-white">
              ...
              <p className="text-[#0369a1] text-sm mb-4">Home collection available across Bengaluru. Female phlebotomist on request.</p>
              <div className="flex flex-wrap gap-3">
          ...
          <div className="lg:col-span-1 space-y-5">
            <div className="bg-gradient-to-br from-sky-600 to-sky-900 text-white rounded-2xl p-5 shadow-lg">
              ...
              <p className="text-[#0369a1] text-xs mb-4">Our team guides you to the right panel based on your clinical requirement.</p>
