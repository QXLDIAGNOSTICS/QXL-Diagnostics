          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                All reports are reviewed by our consultant biochemist and pathologist. Reports include clinical interpretation notes. Doctor enquiries welcome — call +91 9964 639 639.
              </p>
            </section>
