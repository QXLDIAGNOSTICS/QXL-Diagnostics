      ...
      <section className="glass-panel text-[#0c4a6e] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-[#0c4a6e] leading-tight">Advanced Renal Function &amp; Prostate Screening in Bengaluru</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="glass rounded-2xl p-6 text-white">
              ...
              <p className="text-[#0369a1] text-sm mb-4">Fast same-day digital reports. Certified home collection across Bengaluru.</p>
              <div className="flex flex-wrap gap-3">
