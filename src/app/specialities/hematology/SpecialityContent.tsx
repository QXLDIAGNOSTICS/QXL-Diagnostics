          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Critical results (such as platelets &lt; 20,000/µL or presence of blasts) are immediately communicated to the referring clinician via our emergency alert pathway. Contact our pathology team at +91 9964 639 639.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-br from-sky-50 to-white border border-sky-100 rounded-2xl p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  { icon: <CheckCircle className="w-5 h-5 text-sky-600" />, title: "Safe & Painless Extraction", desc: "Trained phlebotomy specialists skilled in pediatric and geriatric blood draws at home." }
                ].map((item, i) => (
