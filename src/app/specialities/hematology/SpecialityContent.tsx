          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Critical results (such as platelets &lt; 20,000/µL or presence of blasts) are immediately communicated to the referring clinician via our emergency alert pathway. Contact our pathology team at +91 9964 639639.
              </p>
            </section>
