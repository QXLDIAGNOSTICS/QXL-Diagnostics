          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                All hormone results are verified by senior pathologists and biochemists, integrating age- and gender-specific reference ranges. Clinician-to-lab consultation is available for case discussions — call +91 99646 36848.
              </p>
            </section>
