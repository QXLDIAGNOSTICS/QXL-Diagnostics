      ...
      <section className="glass-panel text-[#0c4a6e] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-block bg-[#2563eb] text-white text-xs font-extrabold px-3.5 py-1.5 rounded-full uppercase tracking-widest mb-4 shadow-sm">Endocrinology</span>
            <h1 className="text-3xl md:text-5xl font-extrabold mb-4 text-[#0c4a6e] leading-tight">Advanced Endocrine &amp; Hormonal Testing in Bengaluru</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                All hormone results are verified by senior pathologists and biochemists, integrating age- and gender-specific reference ranges. Clinician-to-lab consultation is available for case discussions — call +91 9964 639 639.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-br from-sky-50 to-white border border-sky-100 rounded-2xl p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  { icon: <Shield className="w-5 h-5 text-sky-600" />, title: "NABL Certified Laboratory", desc: "Equipped with state-of-the-art instruments meeting NABL/ISO 15189 standards." },
            ...
            <section className="bg-gradient-to-r from-sky-600 to-sky-800 rounded-2xl p-6 md:p-8 text-white shadow-xl">
              <h3 className="text-xl md:text-2xl font-extrabold mb-2 text-white">Book Your Endocrine/Hormone Test Today</h3>
              <p className="text-sky-100 text-sm md:text-base mb-6 font-medium leading-relaxed">Free home sample collection available across Bengaluru. Digitally verified reports via WhatsApp.</p>
              <div className="flex flex-wrap gap-3">
          ...
          <div className="lg:col-span-1 space-y-5">
            <div className="bg-gradient-to-br from-sky-600 to-sky-800 text-white rounded-2xl p-6 shadow-xl">
              ...
              <a href="tel:+919964639639" className="w-full bg-white font-extrabold py-3 rounded-xl flex justify-center hover:bg-sky-50 transition-colors mb-3 shadow text-sm cursor-pointer" style={{ color: '#0369a1' }}>📞 Call +91 9964 639 639</a>
