...
export default function OncologyPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Banner */}
      <section className="bg-gradient-to-r from-violet-750 to-indigo-950 text-white py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">Advanced Tumor Marker &amp; Cancer Risk Assays in Bengaluru</h1>
            ...
            <div className="flex flex-wrap gap-3">
              <a href="#test-profiles" className="bg-white text-violet-850 font-bold px-5 py-2.5 rounded-full hover:bg-violet-50 transition-colors text-sm" style={{ color: '#6d28d9' }}>View Test Profiles</a>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            {/* CTA Banner */}
            <section className="bg-gradient-to-r from-violet-700 to-indigo-900 rounded-2xl p-6 text-white">
          ...
          <div className="lg:col-span-1 space-y-5">
            <div className="bg-gradient-to-br from-violet-700 to-indigo-950 text-white rounded-2xl p-5 shadow-lg">
              ...
              <a href="tel:+919964639639" className="w-full bg-white font-bold py-2.5 rounded-xl flex justify-center hover:bg-violet-50 transition-colors mb-2 shadow text-sm" style={{ color: '#6d28d9' }}>📞 Call +91 99646 39639</a>
