          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section id="test-profiles">
              <h2 className="text-2xl font-bold text-gray-900 mb-5 flex items-center gap-2">
                <Microscope className="w-6 h-6 text-sky-600" /> Oncology Test Profiles
              </h2>
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Critical results are flagged and immediately routed to the referring oncologist. Case-related medical consultations are available via +91 9964 639 639.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-r from-sky-600 to-sky-800 rounded-2xl p-6 md:p-8 text-white shadow-xl">
              <h3 className="text-xl md:text-2xl font-extrabold mb-2 text-white">Book Your Oncology Marker Panel</h3>
              <p className="text-sky-100 text-sm md:text-base mb-6 font-medium leading-relaxed">Accurate testing with fast, consultant-reviewed digital reports. Home collection available.</p>
              <div className="flex flex-wrap gap-3">
