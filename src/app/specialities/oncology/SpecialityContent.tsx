          ...
          <div className="lg:col-span-2 space-y-10">
                ...
                {[
                  ...
                  <div key={t.name} className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:border-sky-400 hover:shadow-md transition-all">
                    <div className="flex flex-col md:flex-row justify-between gap-3">
                      ...
                      <Link href="/book" className="self-start bg-sky-600 text-white font-semibold px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-750 transition-colors text-sm">Book Now</Link>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Critical results are flagged and immediately routed to the referring oncologist. Case-related medical consultations are available via +91 99646 36848.
              </p>
            </section>
