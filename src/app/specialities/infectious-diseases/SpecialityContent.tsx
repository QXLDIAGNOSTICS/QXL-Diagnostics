      ...
      <section className="glass-panel text-[#0c4a6e] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-block bg-[#2563eb] text-white text-xs font-extrabold px-3.5 py-1.5 rounded-full uppercase tracking-widest mb-4 shadow-sm">Infectious Diseases</span>
            <h1 className="text-3xl md:text-5xl font-extrabold mb-4 text-[#0c4a6e] leading-tight">Advanced Serology &amp; Molecular PCR Testing in Bengaluru</h1>
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                All positive blood and sterile fluid cultures are immediately flagged for critical notification to ensure patient safety. Microbiologist consultations are available at +91 9964 639 639.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-r from-sky-600 to-sky-800 rounded-2xl p-6 md:p-8 text-white shadow-xl">
              <h3 className="text-xl md:text-2xl font-extrabold mb-2 text-white">Book Your Infectious Disease Panel</h3>
              <p className="text-sky-100 text-sm md:text-base mb-6 font-medium leading-relaxed">Same-day reports for routine serology and molecular tests. Home collection available across Bengaluru.</p>
              <div className="flex flex-wrap gap-3">
