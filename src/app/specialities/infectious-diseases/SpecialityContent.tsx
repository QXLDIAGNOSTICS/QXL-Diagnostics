          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                All positive blood and sterile fluid cultures are immediately flagged for critical notification to ensure patient safety. Microbiologist consultations are available at +91 9964 639639.
              </p>
            </section>
