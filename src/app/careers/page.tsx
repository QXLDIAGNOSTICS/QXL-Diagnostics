              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800 text-xs">
                {filtered.map((job) => (
                  <tr key={job.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-950/10">
                    ...
                    <td className="px-6 py-4 font-bold text-sky-650 dark:text-sky-400">{job.department}</td>
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center gap-1 bg-sky-50 dark:bg-sky-950/30 border border-sky-100 text-sky-600 px-2 py-0.5 rounded text-[10px] font-bold">
                    ...
                    <td className="px-6 py-4 text-right flex items-center justify-end gap-1.5 mt-1.5">
                      <button 
                        ...
                        className="p-1.5 text-slate-500 hover:text-sky-650 hover:bg-slate-100 rounded-md cursor-pointer"
