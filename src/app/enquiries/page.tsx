          ...
          <div className="p-4 border-b border-gray-100 dark:border-gray-800 space-y-2">
            <div className="relative w-full">
              ...
              <input 
                ...
                className="w-full pl-9 pr-4 py-2 text-xs bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all text-slate-800 dark:text-slate-100"
              />
            </div>
            ...
            {loading ? (
              ...
              filtered.map((enq) => (
                <div 
                  ...
                  className={`p-4 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors ${selectedEnquiry?.id === enq.id ? "bg-sky-50/40 dark:bg-sky-950/10 border-l-4 border-sky-500" : ""}`}
                >
                  <div className="flex justify-between items-start mb-1.5">
                    <span className="font-extrabold text-xs text-slate-800 dark:text-white">{enq.name}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold text-sky-600 dark:text-sky-400">{enq.subject || "General Enquiry"}</span>
                ...
                <div className="border-t border-gray-100 dark:border-gray-805 pt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-gradient-to-r from-sky-400 to-blue-600 hover:from-sky-500 hover:to-blue-700 text-white text-[10px] font-bold rounded-lg uppercase tracking-wider flex items-center gap-1 shadow-xs cursor-pointer"
                    >
                  ...
                  {aiReply && (
                    <div className="space-y-2 animate-in fade-in duration-200">
                      <textarea
                        ...
                        className="w-full p-4 bg-sky-50/10 border border-sky-200/50 dark:border-sky-900/40 rounded-xl text-xs font-mono text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-1 focus:ring-sky-500"
                      />
