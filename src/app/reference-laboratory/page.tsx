...
export const metadata: Metadata = {
  ...
  description: "QXL Diagnostics reference laboratory services for hospitals, polyclinics, nursing homes, and diagnostic centres across Bengaluru & Karnataka. NABL Certified (MC-6849), specialized testing & MD pathologist review.",
