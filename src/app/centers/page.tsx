...
const DEFAULT_CENTERS = [
  ...
  {
    id: "center-2",
    name: "Yelahanka (Galleria Mall) – North City Specialities, Powered by QXL Diagnostics (NABL Accredited)",
    slug: "yelahanka-galleria-mall",
    pincode: "560064",
    locality: "Yelahanka",
  ...
  {
    id: "center-3",
    name: "Nayandahalli (Mysuru Road) – Spandana Hospital, Powered by QXL Diagnostics",
    slug: "nayandahalli-spandana-hospital",
    pincode: "560039",
    locality: "Nayandahalli",
    address: "Spandana Hospital, Mysuru Road, Nayandahalli, Bengaluru – 560039",
    city: "Bengaluru",
    phone: PHONE_DISPLAY,
    hours: "Walk-in & Sample Collection: 7:00 AM – 8:00 PM (Mon–Sun)",
    lat: 12.9468,
    lng: 77.5255,
    is_nabl: true,
    type: "physical_centre",
  ...
  {
    id: "center-4",
    name: "Nagarabhavi – Astrio Multispeciality Hospital, Powered by QXL Diagnostics",
    slug: "nagarabhavi-astrio-hospital",
    pincode: "560072",
    locality: "Nagarabhavi",
    address: "Astrio Multispeciality Hospital, Nagarabhavi, Bengaluru – 560072",
    city: "Bengaluru",
    phone: PHONE_DISPLAY,
    hours: "Walk-in & Sample Collection: 7:00 AM – 8:00 PM (Mon–Sun)",
    lat: 12.9616,
  ...
  {
    id: "center-5",
    name: "Chandra Layout – Nandi Diagnostics, Powered by QXL Diagnostics",
    slug: "chandra-layout-nandi-diagnostics",
    pincode: "560040",
    locality: "Chandra Layout",
    address: "Nandi Diagnostics, Chandra Layout, Bengaluru – 560040",
    city: "Bengaluru",
    phone: PHONE_DISPLAY,
    hours: "Walk-in & Sample Collection: 7:00 AM – 8:00 PM (Mon–Sun)",
    lat: 12.9555,
  ...
  {
    id: "center-6",
    name: "Yelahanka Old Town – Shushrusha Hospital, Powered by QXL Diagnostics",
    slug: "yelahanka-old-town-shushrusha",
    pincode: "560064",
    locality: "Yelahanka Old Town",
    address: "Shushrusha Hospital, Yelahanka Old Town, Bengaluru – 560064",
    city: "Bengaluru",
    phone: PHONE_DISPLAY,
    hours: "Walk-in & Sample Collection: 7:00 AM – 8:00 PM (Mon–Sun)",
    lat: 13.0942,
  ...
  {
    id: "center-7",
    name: "Sanjaynagar – Nisarga Diagnostics, Powered by QXL Diagnostics",
    slug: "sanjaynagar-nisarga-diagnostics",
    pincode: "560094",
    locality: "Sanjaynagar",
    address: "Nisarga Diagnostics, Sanjaynagar, Bengaluru – 560094",
    city: "Bengaluru",
    phone: PHONE_DISPLAY,
    hours: "Walk-in & Sample Collection: 7:00 AM – 8:00 PM (Mon–Sun)",
    lat: 13.0416,
  ...
  {
    id: "center-8",
    name: "Vidyaranyapura – Dr. Abhi Kollur's Clinic, Powered by QXL Diagnostics",
    slug: "vidyaranyapura-dr-abhi-kollur",
    pincode: "560097",
    locality: "Vidyaranyapura",
    address: "Dr. Abhi Kollur's Clinic, Vidyaranyapura, Bengaluru – 560097",
    city: "Bengaluru",
    phone: PHONE_DISPLAY,
    hours: "Walk-in & Sample Collection: 7:00 AM – 8:00 PM (Mon–Sun)",
    lat: 13.0805,
