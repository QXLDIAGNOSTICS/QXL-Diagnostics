                ...
                <div className="lg:w-1/2 p-6 flex flex-col justify-between">
                  ...
                  <div className="flex items-center justify-end gap-3 mt-6 border-t border-gray-100 dark:border-gray-850 pt-4">
                    <button 
                      ...
                      className="p-2 text-slate-600 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-slate-100 dark:hover:bg-gray-800 rounded-lg transition-colors cursor-pointer"
                      title="Edit Banner"
                    >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/55 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-100 dark:border-gray-800 flex flex-col">
            ...
            <div className="px-6 py-4 bg-sky-50/50 dark:bg-sky-950/10 border-b border-sky-100/50 dark:border-sky-900/10">
              {!showAiInput ? (
                <button
                  type="button"
                  onClick={() => setShowAiInput(true)}
                  className="w-full py-2 bg-gradient-to-r from-sky-400 to-blue-600 text-white rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:opacity-95 shadow-sm cursor-pointer"
                >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-extrabold text-sky-800 dark:text-sky-400 flex items-center gap-1.5">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-xs bg-white dark:bg-gray-800 border border-sky-200 dark:border-sky-900 rounded-lg text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-sky-500"
                    />
                    <button
                      type="button"
                      disabled={isAiGenerating || !aiPrompt}
                      onClick={handleAiGenerate}
                      className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white text-xs font-bold rounded-lg disabled:opacity-50 flex items-center gap-1 cursor-pointer"
                    >
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4 flex-1">
                ...
                <>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full px-3.5 py-2.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-sky-500 resize-none"
                    ></textarea>
                  </div>
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-3 sticky bottom-0 bg-white dark:bg-gray-900 py-4 z-10">
                ...
                <button 
                  type="submit" 
                  disabled={saving}
                  className="px-6 py-2 bg-sky-600 hover:bg-sky-700 disabled:opacity-60 text-white rounded-lg text-sm font-medium shadow-sm cursor-pointer flex items-center gap-2"
                >
