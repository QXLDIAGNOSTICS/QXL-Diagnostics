      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-150 dark:border-gray-800 shadow-sm overflow-hidden p-6 max-w-4xl">
        <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="Careers" 
                      className="w-full px-3.5 py-2 text-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-sky-500"
                    />
                  </div>
                  <div>
                  ...
                  <button 
                    type="button" 
                    onClick={addNavItem}
                    className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white font-bold rounded-lg text-xs flex items-center justify-center gap-1.5 cursor-pointer h-10 shadow-sm"
                  >
                ...
                <div className="border border-gray-150 dark:border-gray-800 rounded-xl divide-y divide-gray-150 dark:divide-gray-800 overflow-hidden bg-white dark:bg-gray-900">
                  {(settings.timeline || []).map((t: any, idx: number) => (
                    <div key={idx} className="px-4 py-3 flex items-center justify-between text-xs hover:bg-slate-50/50">
                      <div>
                        <span className="font-extrabold text-sky-650 dark:text-sky-400 bg-sky-50 dark:bg-sky-950/20 px-2 py-0.5 rounded-md mr-3">{t.year}</span>
          ...
          <div className="pt-5 border-t border-gray-150 dark:border-gray-850 flex items-center justify-between">
            ...
            <button 
              type="submit" 
              className="px-6 py-2.5 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-xs font-bold flex items-center gap-2 shadow-md hover:scale-[1.01] transition-all cursor-pointer ml-auto"
            >
