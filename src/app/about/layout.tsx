...
export const metadata: Metadata = {
  ...
  description:
    "Learn about QXL Diagnostics — NABL Certified (MC-10025) ISO 15189:2022 super speciality diagnostic laboratory in Bengaluru founded by Dr. Shantakumar Muruda. Mission, centres, and clinical excellence.",
