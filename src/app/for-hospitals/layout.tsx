...
export const metadata: Metadata = {
  ...
  description:
    "Partner with QXL Diagnostics for NABL-accredited pathology, microbiology, and molecular diagnostics support for your hospital or clinic in Bengaluru.",
  alternates: { canonical: "/for-hospitals" },
  openGraph: {
    title: "Diagnostic Partnerships for Hospitals | QXL Diagnostics",
    description: "NABL-accredited pathology and diagnostics partnership for hospitals and clinics.",
