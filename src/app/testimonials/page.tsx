      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Star className="w-6 h-6 text-sky-600 dark:text-sky-400" />
            Testimonials Mgt
          </h2>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-150 dark:border-gray-800 shadow-sm overflow-hidden">
        ...
        {filtered.length === 0 ? (
          <div className="p-12 text-center text-gray-400">
            {loading ? <Loader2 className="w-6 h-6 animate-spin text-sky-600 mx-auto" /> : "No testimonials found."}
          </div>
        ) : (
                ...
                <div className="mt-6 pt-3 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="p-1.5 text-slate-400 hover:text-sky-600 rounded-md cursor-pointer"
                    >
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-slate-650 dark:text-slate-350 focus:outline-none focus:ring-2 focus:ring-sky-500"
                >
              ...
              <div className="pt-4 flex justify-end gap-3 border-t border-gray-100 dark:border-gray-800">
                ...
                <button 
                  type="submit" 
                  disabled={saving}
                  className="px-5 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-xs font-medium shadow-sm cursor-pointer disabled:opacity-60 flex items-center gap-2"
                >
