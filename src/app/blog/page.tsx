                ...
                <div className="mt-6 pt-3 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="p-1.5 text-slate-500 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-slate-100 dark:hover:bg-gray-800 rounded-md transition-colors cursor-pointer"
                    >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/55 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-2xl w-full shadow-2xl border border-gray-150 dark:border-gray-800 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            {/* AI Blog Writer */}
            <div className="px-6 py-3 bg-sky-50/50 dark:bg-sky-950/10 border-b border-sky-100/50 dark:border-sky-900/10">
              {!showAiInput ? (
                <button
                  type="button"
                  onClick={() => setShowAiInput(true)}
                  className="w-full py-2 bg-gradient-to-r from-sky-400 to-blue-600 text-white rounded-lg text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:opacity-95 shadow-xs cursor-pointer"
                >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-sky-800 dark:text-sky-400 flex items-center gap-1.5">
