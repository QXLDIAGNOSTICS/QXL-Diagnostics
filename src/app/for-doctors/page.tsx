...
export const metadata: Metadata = {
  ...
  description: "B2B reference laboratory services, hospital lab outsourcing, critical value alerts, and specialist pathologist consultation in Bengaluru. NABL Certified (MC-10025).",
