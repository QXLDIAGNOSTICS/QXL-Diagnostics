...
export const metadata: Metadata = {
  ...
  description: "Book blood tests in Bangalore with QXL Diagnostics. 300+ tests, NABL Certified lab, free home sample collection across Bengaluru, same-day digital reports.",
  alternates: {
