...
export const metadata: Metadata = {
  ...
  description: "At QXL Diagnostics, laboratory medicine is led by doctors—not just machines. NABL Certified (MC-10025) routine & super-speciality reference diagnostics across Bengaluru.",
      ...
      <section className="py-14 max-w-[1200px] mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Testing is supported by NABL Certified laboratory processes (MC-10025), ISO 15189:2022 standards, and daily multi-rule Westgard IQC.
            </p>
          </div>
