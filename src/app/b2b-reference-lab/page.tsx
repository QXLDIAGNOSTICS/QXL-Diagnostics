...
export const metadata: Metadata = {
  ...
  description: "B2B diagnostic testing, reference lab partnerships, and hospital laboratory outsourcing across Bengaluru. NABL Certified (MC-10025), ISO 15189:2022 standards.",
};
        ...
        <div className="max-w-[1260px] mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-blue-100 text-base md:text-lg mb-8 leading-relaxed font-medium">
              Outsource specialized pathology, histopathology, molecular testing, and rare bio-assays to our NABL Certified (MC-10025) central laboratory in Kengeri, Mysuru Road.
            </p>
      ...
      <section className="py-12 max-w-[1260px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6 rounded-2xl bg-white border border-slate-200 shadow-sm">
            ...
            <h3 className="text-lg font-bold text-[#0f2d5e] mb-2">NABL Certified Quality</h3>
