...
export const metadata: Metadata = {
  ...
  description: "B2B diagnostic testing, reference lab partnerships, and hospital laboratory outsourcing across Bengaluru. NABL Certified (MC-6849), ISO 15189:2022 standards.",
};
        ...
        <div className="max-w-[1260px] mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-blue-100 text-base md:text-lg mb-8 leading-relaxed font-medium">
              Outsource specialized pathology, histopathology, molecular testing, and rare bio-assays to our NABL Certified (MC-6849) central laboratory in Kengeri, Mysuru Road.
            </p>
